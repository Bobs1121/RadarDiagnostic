...
**范围**：
- [x] `docs/archive/2026-09-17/technical/V4_PI_DRIVEN_ARCHITECTURE.md` — 顶层架构设计（含质量属性/能力边界/交互/多项目/记忆分层/隔离）
- [x] `docs/archive/2026-09-17/technical/V4_DEVELOPMENT_PLAN.md` — 本文件
- [x] `docs/archive/2026-09-17/technical/V4_DESIGN_CONTEXT_AND_DECISIONS.md` — 需求与决策上下文（防遗漏基线）

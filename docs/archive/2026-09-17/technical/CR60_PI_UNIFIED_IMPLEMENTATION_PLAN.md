...
> 2026-09-16：新一轮实施优先使用 [Gen6 开发与验收计划](../../../technical/GEN6_AI_DEVELOPMENT_PLAN_2026-09-16.md) 和 [产品基线](../../../technical/GEN6_AI_PRODUCT_BASELINE_2026-09-16.md)。下文固定 HILMODEL 数值及预热帧数仅为历史方案，不得作为跨版本执行默认值；应读取当前源码/有效构建并验证。单雷达可用于开发切片，但不能替代多雷达多事件产品验收。

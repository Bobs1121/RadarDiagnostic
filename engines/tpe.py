...
* :class:`engines.pattern_extractor.PatternExtractor` — code side
* :class:`engines.temporal_analyzer.TemporalAnalyzer` — data side
* :class:`engines.causal_aligner.CausalAligner`       — glue
